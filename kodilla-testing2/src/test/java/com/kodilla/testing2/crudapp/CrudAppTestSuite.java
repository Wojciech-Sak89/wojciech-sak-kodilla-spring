...
public class CrudAppTestSuite {
    private static final String BASE_URL = "https://wojciech-sak89.github.io/";
    ...
    public void shouldCreateTrelloCard() throws InterruptedException {
        ...
        cleanUpCreatedCrudAppTestTask(taskName);
    }
    ...
    private boolean checkTaskExistsInTrello(String taskName) throws InterruptedException {
        ...
        driverTrello.findElement(By.id("user")).sendKeys("wojciech.r.sak@gmail.com");
        driverTrello.findElement(By.id("password")).sendKeys("ztbyQh*77d@X5JDY#uWV");
    ...
    private void cleanUpCreatedCrudAppTestTask(String taskName) throws InterruptedException {
